                ...
                <h1 class="display-3  text-dark my-2">Cadastro de produtos</h1>
                  ...
                  <div class="form-group">
                    <label for="fornecedor">Nome</label>
                      <input disabled="" name="product-name" type="text" class="form-control" id="nome">
                  </div>
                  <div class="form-group">
                    <label for="fornecedor">Preço</label>
                      <input disabled="" placeholder="00.00" name="product-price" type="text" class="form-control" id="preco">
                  </div>
                  <div class="input-group mb-3">
                    <div class="custom-file">
                      <label class="custom-file-label" for="addImg" aria-describedby="addImg">Adcionar imagem do produto</label>
                      <input type="file" name="product-src" class="custom-file-input" id="addImg">               
                    </div>                   
                  </div>
                  <div class="form-group">
                    <label for="fornecedor">Fornecedor</label>
                      <input disabled="" name="drink-supplier" type="text" class="form-control" id="fornecedor">
                  </div>
                  <div class="form-group">
                    <label for="descricao">Ingredientes</label>
                    <textarea disabled="" placeholder="Adicione os ingredientes separados por virgula" name="food-ingredients" class="form-control" id="ingredientes" ></textarea>
                  </div>
