            ...
            <div class="row justify-content-around">
                ...
                <div class="col-md-3 ">
                    <a href="">
                        ...
                        <div > 
                            <a href="../view/breakfest.php"><img class="cardapio  img-fluid" src="../images//breakfest/breakfest2.jpg" alt="café"></a>
                        </div>
                ...
                <div class="col-md-3 " >
                    <a href="">
                        <div >
                           <a href="../view/lunch.php" ><img class="cardapio  img-fluid" src="../images/lunch/lunch2.jpg" alt="almoço"></a>
                        </div>
                ...
                <div class="col-md-3 " >
                    <a href="">
                        <div >
                            <a href="../view/dinner.php"><img class="cardapio img-fluid " src="../images/dinner/dinner2.jpg" alt="jantar"></a>
                        </div>
                ...
                <div class="col-md-3 " >
                    <a href="">
                        <div >
                            <a href="../view/drink.php"><img class="cardapio  img-fluid" src="../images/drink/drink.jpg" alt="bebidas"></a>
                        </div>
                       <div >
