...
<head>
   ...
   <!-- <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>-->
    ...
    <!-- Estilo customizado -->
    <link rel="stylesheet" type="text/css" href="../public/style/registerProducts.css">
</head>
    ...
    <nav class="navbar navbar-expand-sm navbar-warning nav-bg  nav-transparente">
        <div class="container">
          ...
          <a  href="#" class="navbar-brand" style="color: white;">
           <img src="../public/imagens/logo/logo-removebg-preview.png" alt="" width="120px" class="logo" >
          </a>    
          <!--Menu Hamburguer-->
